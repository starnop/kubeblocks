...
func (in *InstanceSetSpec) DeepCopyInto(out *InstanceSetSpec) {
	*out = *in
	...
	if in.TemplatesIndexRanges != nil {
		in, out := &in.TemplatesIndexRanges, &out.TemplatesIndexRanges
		*out = make([]InstanceTemplateIndexRanges, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstanceTemplateIndexRanges) DeepCopyInto(out *InstanceTemplateIndexRanges) {
	*out = *in
	if in.IndexRanges != nil {
		in, out := &in.IndexRanges, &out.IndexRanges
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstanceTemplateIndexRanges.
func (in *InstanceTemplateIndexRanges) DeepCopy() *InstanceTemplateIndexRanges {
	if in == nil {
		return nil
	}
	out := new(InstanceTemplateIndexRanges)
	in.DeepCopyInto(out)
	return out
}
